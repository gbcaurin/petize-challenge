...
function Home() {
  ...
  const { t, i18n } = useTranslation(); //i18n permite trocar o idioma

  return (
    //flex ocupa a tela toda
    <Flex width="100vw" height="100vh" position="relative">
      {/* elect de idioma fixo no canto superior direito */}
      <Select
        position="absolute"
        top={4}
        right={4}
      ...
      <Flex
        ...
        justify="center"
      >
        {/*VStack deixa tudo vertical com espaço*/}
        <VStack spacing={4} width="80%" maxWidth="400px">
          <Heading color="#e6edf3" fontSize="2xl" textAlign="center">
            {t("home.text")}
          </Heading>
          ...
          <Input
            ...
            onKeyDown={(e) =>
              e.key === "Enter" && navigate(`/profile/${username}`)
